...
class CreateTest extends DbWebTestCase
{
    ...
    public function testNotValid(): void
    {
        ...
        $this->assertStringContainsString('This value should not be blank.', $crawler
            ->filter('#form_firstName')->ancestors()->first()->filter('.form-error-message')->text());

        $this->assertStringContainsString('This value should not be blank.', $crawler
            ->filter('#form_lastName')->ancestors()->first()->filter('.form-error-message')->text());

        $this->assertStringContainsString('This value is not a valid email address.', $crawler
            ->filter('#form_email')->ancestors()->first()->filter('.form-error-message')->text());
    }
